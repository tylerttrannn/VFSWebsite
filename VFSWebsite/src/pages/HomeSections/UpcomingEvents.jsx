...
export default function UpcomingEvents() {
    return (
        <div className={"py-5 bg-white flex flex-col text-center"}>
            ...
            <div className="flex flex-col sm:flex-row items-center text-start justify-center gap-5 sm:gap-10 border-y-2 p-4 border-black/20">
                ...
                <img src={jeopardy} alt="Jeopardy Night Flyer" className="w-[150px] sm:w-[100px] rounded-lg shadow-md"/>
