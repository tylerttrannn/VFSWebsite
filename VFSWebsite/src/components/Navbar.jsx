    ...
    return (
        <div className="flex flex-row justify-between items-center md:mx-10">
            ...
            <div className="flex gap-8 text-lg text-grey">
                <Link to={"https://www.instagram.com/vfs_uci/"}>
                    <FontAwesomeIcon icon={faInstagram} />
                </Link>
                <Link to={"https://www.linkedin.com/company/the-vertical-flight-society-at-uci/"}>
                    <FontAwesomeIcon icon={faLinkedinIn} />
                </Link>
                <Link to={"https://discord.com/invite/ea37NfeuGb"}>
